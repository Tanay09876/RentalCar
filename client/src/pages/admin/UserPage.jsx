...
//       <Title
//         title="Manage Users"
//         subTitle="View and manage all registered users, filter by role, and search by name or email."
//       />
...
//                     <button
//                       onClick={() =>
//                         (window.location.href = `mailto:${user.email}?subject=Hello ${user.name}&body=Hi ${user.name},`)
//                       }
