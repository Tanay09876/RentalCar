    ...
    try {
      if (state === "forgot") {
        ...
        if (!otp || !newPassword || newPassword.length < 8) {
          toast.error("Please enter valid OTP and new password (min 8 chars)");
          return;
        }
      ...
      >
        ...
        {state === "otp" && (
          <div className="w-full flex justify-between items-center text-sm">
            <span className="text-primary cursor-pointer" onClick={() => setState("login")}>Back to Login</span>
            <span className="text-primary cursor-pointer" onClick={resendOTP}>Resend OTP</span>
          </div>
        )}
...
//               Can't get OTP?{" "}
//               <button onClick={resendOTP} type="button" className="text-red-500 underline">
//                 Resend
//               </button>
//             </span>
//           </div>
