  ...
  return (
    <div className='relative min-h-screen md:flex flex-col items-center pt-8 max-w-13 md:max-w-60 w-full border-r border-borderColor text-sm'>
      ...
      <div className='w-full'>
        {ownerMenuLinks.map((link, index) => (
          <NavLink
            ...
            className={`relative flex items-center gap-2 w-full py-3 pl-4 first:mt-6 ${
              link.path === location.pathname ? 'bg-primary/10 text-primary' : 'text-gray-600 hover:bg-primary/10 hover:text-primary'
            }`}
          >
        ...
        {/* Logout Link Styled Like NavLink */}
        <NavLink
          to="#"
          onClick={(e) => {
            e.preventDefault()
          ...
          className='relative flex items-center gap-2 w-full py-3 pl-4 text-gray-600 hover:bg-primary/10 hover:text-primary cursor-pointer mt-6'
        >
